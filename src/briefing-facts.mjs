...
export const HELP_FACT = 'Where you can get help, two places: (1) your backend reasoning model, gpt-5.6-sol, which thinks things through and runs your tools (take_note, present_slides, point_at, scroll, ask_coding_agent); (2) the coding session, reached through ask_coding_agent, which can read files, run code, research, search the web and put documents on your shared screen. You cannot search the web yourself, and neither can the backend model; ask the coding session.';
