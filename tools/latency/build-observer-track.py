# Observer microphone track: t=0 is when Meet opens the (fake) mic on the pre-join page.
...
SR = 48000
schedule = [(6.0, 'hello'), (9.0, 'hello'), (16.0, 'hello'), (22.0, 'who'), (32.0, 'session'), (42.0, 'bye')]
END = 46.0
...
wavfile.write('observer-track.wav', SR, (track * 32767).astype(np.int16))
json.dump({'sampleRate': SR, 'end': END, 'utterances': placed}, open('observer-track.json', 'w'), indent=1)
print(placed)
